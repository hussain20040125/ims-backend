...
const InventorySchema = new Schema({
  ...
  // total_qty = available + allocated + issued
  availableQty: { type: Number, default: 0 },
  // Layer 1: Free stock
  allocatedQty: { type: Number, default: 0 },
  // Layer 2: Reserved/Locked for MR
  issuedQty: { type: Number, default: 0 },
  // Layer 3: Physically moved out
...
const MaterialPlanSchema = new Schema({
  ...
  status: {
    type: String,
    enum: ["Draft", "Pending Approval", "Approved", "Rejected", "PO Raised", "Fulfilled", "Open"],
    default: "Draft"
  },
  submittedBy: String,
  submittedAt: Date,
...
const InwardReturn = mongoose.model("InwardReturn", InwardReturnSchema);
...
const OutwardReturn = mongoose.model("OutwardReturn", OutwardReturnSchema);
...
const SettingsSchema = new Schema({
  poThreshold: { type: Number, default: 25e3 },
...
const MRAllocationSchema = new Schema({
  ...
  remainingQty: { type: Number, default: 0 },
  allocatedBy: String,
  allocationDate: { type: String, default: /* @__PURE__ */ __name(() => (/* @__PURE__ */ new Date()).toISOString(), "default") },
  date: { type: String, default: /* @__PURE__ */ __name(() => (/* @__PURE__ */ new Date()).toISOString().split("T")[0], "default") },
...
const MRAllocation = mongoose.model("MRAllocation", MRAllocationSchema);
...
const MaterialPlanRevision = mongoose.model("MaterialPlanRevision", MaterialPlanRevisionSchema);
